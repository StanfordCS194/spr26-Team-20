...
const _kSavedPrinterId = 'saved_printer_id_v1';
...
class AppPreferences {
  ...
  String get savedPrinterId => _prefs.getString(_kSavedPrinterId) ?? '';
  Future<void> markIntroTourSeen() => _prefs.setBool(_kSeenIntroTour, true);
  Future<void> setSavedPrinterId(String printerId) =>
      _prefs.setString(_kSavedPrinterId, printerId.trim());
